#!/bin/bash
#SBATCH --job-name=lighteval_llama31_8b_sft_slerp0305-emb_analysis
#SBATCH --mem=80G
...
log_base_dir="/path/to/cva-merge/evaluation/logs/analysis"
...
# Run the script
model_name="/path/to/models/${model_abbrev}-${lang_code}-madlad-mean-slerp0305-emb"
tasks=(
