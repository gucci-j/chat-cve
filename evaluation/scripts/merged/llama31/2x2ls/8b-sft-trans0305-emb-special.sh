#!/bin/bash
#SBATCH --job-name=lighteval_llama31_8b_sft_trans0305-emb-special
#SBATCH --mem=80G
...
custom_task_script_dir="/path/to/cva-merge/evaluation/src"
log_base_dir="/path/to/cva-merge/evaluation/logs/merged"
...
# Run the script
model_name="/path/to/models/${model_abbrev}-${lang_code}-madlad-mean-trans0305-emb-special"
tasks=(
